...
echo -e "  ${BOLD}1.${NC} Set your ESPN credentials:"
echo -e "     ${DIM}uv run --project $SCRIPT_DIR espn auth token <ESPN_S2> <ESPN_SWID>${NC}"
echo -e ""
echo -e "     Get cookies from: ESPN Fantasy > browser DevTools > Application > Cookies"
echo -e "     Copy the values of ${BOLD}espn_s2${NC} and ${BOLD}SWID${NC}"
echo -e ""
